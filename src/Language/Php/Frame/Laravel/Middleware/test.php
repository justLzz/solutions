...
use Solutions\Language\Php\Frame\Laravel\Middleware\VerifyCSRFToken;
use Solutions\Language\Php\Frame\Laravel\Middleware\SetCookie;
use Solutions\Language\Php\Frame\Laravel\Middleware\VerifyAuth;
